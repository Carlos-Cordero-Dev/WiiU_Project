...
static inline bool GLSL_Init()
{
    ...
    // find exports
    OSDynLoad_FindExport(s_glslCompilerModule, 0, "InitGLSLCompiler", (void**)&_InitGLSLCompiler);
    OSDynLoad_FindExport(s_glslCompilerModule, 0, "CompileVertexShader", (void**)&GLSL_CompileVertexShader);
    OSDynLoad_FindExport(s_glslCompilerModule, 0, "CompilePixelShader", (void**)&GLSL_CompilePixelShader);
    OSDynLoad_FindExport(s_glslCompilerModule, 0, "FreeVertexShader", (void**)&GLSL_FreeVertexShader);
    OSDynLoad_FindExport(s_glslCompilerModule, 0, "FreePixelShader", (void**)&GLSL_FreePixelShader);
    OSDynLoad_FindExport(s_glslCompilerModule, 0, "DestroyGLSLCompiler", (void**)&__GLSL_DestroyGLSLCompiler);
#else
